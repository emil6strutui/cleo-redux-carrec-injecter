...
declare class List {
    ...
    * https://library.sannybuilder.com/#/sa?q=INSERT_LIST_VALUE_BY_INDEX [0F08]*/
    insertValueByIndex(index: int, value: int): List;
    ...
    * https://library.sannybuilder.com/#/sa?q=REPLACE_LIST_VALUE_BY_INDEX [0F06]*/
    replaceValueByIndex(index: int, value: int): List;
...
declare class Matrix {
    ...
    * https://library.sannybuilder.com/#/sa?q=ROTATE_MATRIX_ON_AXIS [0D01]*/
    rotateOnAxis(axisX: float, axisY: float, axisZ: float, angle: float, combineOp: int): Matrix;
...
declare class RenderObject {
    ...
    * https://library.sannybuilder.com/#/sa?q=CREATE_RENDER_OBJECT_TO_CHAR_BONE [0E2E]*/
    static CreateToCharBone(char: Char, modelId: int, pedBone: int, x: float, y: float, z: float, rx: float, ry: float, rz: float): RenderObject;
...
interface SampClient {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_READ_SAMP_MEMORY_WITH_OFFSET [0B2E]*/
    ReadMemoryWithOffset(offset: int, size: int): int;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_WRITE_SAMP_MEMORY_WITH_OFFSET [0B2D]*/
    WriteMemoryWithOffset(offset: int, value: int, size: int): void;
}
...
declare class SfD3DFont {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_D3D_CREATE_FONT [0B6D]*/
    static Create(fontName: string, size: int, styleFlags: int): SfD3DFont;
...
interface Task {
    ...
    * https://library.sannybuilder.com/#/sa?q=TASK_PICK_UP_OBJECT [070A]*/
    PickUpObject(char: Char, object: ScriptObject, xOffset: float, yOffset: float, zOffset: float, bone: int, orientation: int, animationName: string, animationFile: string, time: int): void;
    PickUpSecondObject(char: Char, object: ScriptObject, xOffset: float, yOffset: float, zOffset: float, boneId: int, orientation: int, animationName: string, animationFile: string, time: int): void;
